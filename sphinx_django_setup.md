...
To autobuild documents and autoreload browswer, use [sphinx-autobuild](https://pypi.python.org/pypi/sphinx-autobuild).
To autobuild a classical Sphinx documentation set, issue the following command:
```
sphinx-autobuild docs docs/_build/html
```

# Autobuild integration in make file
